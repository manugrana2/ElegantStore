    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header border-0">
                <h1 class="font-bold">Inicia Sesión <span class="text-primary">para comprar</span></h1>
            ...
            <div class="modal-body">
                ...
                <form id="login__form" class="">
                    ...
                    <!-- Password input -->
                    <div class="form-group">
                        <label for="login__password">Ingresa tu contraseña</label>
                    ...
                    <div class="modal-footer px-0 border-0 d-flex justify-content-between">
                        <a href="#!" data-dismiss="modal" data-toggle="modal" data-target="#register__modal">Registrate Aquí</a>
                        <span>
