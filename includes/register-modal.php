    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header border-0">
                <h1 class="font-bold">Registrate <span class="text-primary">para unirte</span></h1>
            ...
            <div class="modal-body">
                ...
                <!-- Login form -->
                <form id="register__form" class="">
                    <div class="form-row">
                        <!-- First name input -->
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="register__firstname">Nombres</label>
                        ...
                        <!-- Last name input -->
                        <div class="col-md-6">
                            <label for="register__lastname">Apellidos</label>
                    ...
                    <div class="form-group">
                        ...
                        <div class="invalid-feedback">
                           El usuario ya existe! Utiliza otra email.
                        </div>
                    </div>
                    <!-- Password input -->
                    <div class="form-group">
                        <label for="register__password">Escoge y escribe tu contraseña</label>
                    ...
                    <div class="modal-footer px-0 border-0 d-flex justify-content-between">
                        <a href="#" data-dismiss="modal" data-toggle="modal" data-target="#login__modal">Inicia Sesión aquí</a>
                        <span>
